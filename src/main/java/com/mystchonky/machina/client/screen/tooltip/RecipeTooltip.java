...
public record RecipeTooltip(GearRecipe recipe) implements TooltipComponent {

    public static class RecipeTooltipRenderer implements ClientTooltipComponent {

        private final GearRecipe recipe;

        public RecipeTooltipRenderer(GearRecipe recipe) {
            this.recipe = recipe;
        }
